...
import { hotelData } from '../addhotels/addhotels.component';
...
export class BookroomComponent implements OnInit {
  ...
  tempArray:any[];
  displayedColumns = ['hotelName','hotelType','hotelRating','phoneNumber','Options'];
  ...
  search() {
    ...
    console.log(t)
      this.hotelService.getHotelCity(t).subscribe(data=>{
        console.log(data)
        this.tempArray=data;
  ...
  book(row1) {
    this.dialog.open(BookhotelComponent,{data:{row1},autoFocus:false,disableClose:true})
  }
