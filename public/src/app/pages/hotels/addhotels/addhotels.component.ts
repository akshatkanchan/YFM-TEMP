...
@Component({
  ...
  styleUrls: ['./addhotels.component.scss']
})
export class AddhotelsComponent implements OnInit {
  ...
  saveHotel() {
    ...
    this.hotelService.addHotels(this.hotelData).subscribe(data => {
      console.log(data)
      this.param.inserted='yes';
      this.hotelData.id = data.insertId;
      this.param.data=this.hotelData;            
    },err=>{},()=>{
      this.ws.send(this.user.ownerId+"hotel");
      this.snackBar.open("Hotel Added", "X", {duration: 3000});
  ...
  updateHotel() {
    ...
    this.hotelData.termsAndConditions = this.newHotel.get('termsAndConditions').value;
    this.hotelData.ownerID = this.user.ownerId;
    this.hotelService.updateHotel(this.hotelData).subscribe(data=>{},err=>{},()=>{
      this.ws.send(this.user.ownerId+"hotel");
      this.snackBar.open("Hotel Updated", "X", {duration: 3000});
      this.dialog.closeAll();
    })
  }
