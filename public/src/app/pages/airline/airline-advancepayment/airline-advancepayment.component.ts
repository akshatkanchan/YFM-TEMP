...
@Component({
  ...
  templateUrl: './airline-advancepayment.component.html',
  styleUrls: ['./airline-advancepayment.component.scss']
})
export class AirlineAdvancepaymentComponent implements OnInit {
  ...
  saveAdvancePayment() {
    ...
    this.advancepaymentService.addFlightAdvancePayment(this.advancePayment).subscribe(data => {},err=>{},()=>{
