...
@Component({
  ...
  templateUrl: './importbookings.component.html',
  styleUrls: ['./importbookings.component.scss']
})
export class ImportbookingsComponent implements OnInit {
  ...
  constructor(private bookingService:BookingsService, private auth:AuthService, private http:Http, private dialog: MatDialog)
  {
