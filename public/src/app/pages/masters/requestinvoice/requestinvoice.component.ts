...
@Component({
  ...
  styleUrls: ['./requestinvoice.component.scss']
})
export class RequestinvoiceComponent implements OnInit {
  
  mailBody: any;
  mailSubject: any = "Invoice Request";
