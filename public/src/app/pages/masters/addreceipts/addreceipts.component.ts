...
@Component({
  ...
  styleUrls: ['./addreceipts.component.scss'],
  templateUrl: './addreceipts.component.html',
})
export class AddReceiptsComponent implements OnInit{
  ...
  addInvoices(){
    ...
    else
    {
      ...
      this.dialog.open(SelectinvoicesComponent,{data:params,autoFocus:false,disableClose:true}).afterClosed().subscribe(data=>
        { this.finalTotal=0;
          // console.log(data)
  ...
  saveReceipt()
  {
    ...
    else
    {
      ...
      {       
        ...
        this.receiptService.addReceipt(this.receipt).subscribe(data=>{
          ...
          this.selectedInvoices.forEach(element => {
            ...
            console.log(element)
            this.receiptService.addInvoices(temp).subscribe();
          });
  ...
  getInvoicesData()
  {
    this.receiptService.getInvoiceInReceipts(this.receipt).subscribe(data=>{
