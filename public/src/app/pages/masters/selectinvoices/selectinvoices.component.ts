...
@Component({
  ...
  templateUrl: './selectinvoices.component.html',
  styleUrls: ['./selectinvoices.component.scss']
})
export class SelectinvoicesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.invoiceService.getCustInvoices(this.selectedCustomer).subscribe(data=>
      {
