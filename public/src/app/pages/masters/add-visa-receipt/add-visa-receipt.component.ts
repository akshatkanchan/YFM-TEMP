...
@Component({
  ...
  templateUrl: './add-visa-receipt.component.html',
  styleUrls: ['./add-visa-receipt.component.scss']
})
export class AddVisaReceiptComponent implements OnInit {
  ...
  addInvoices(){
    ...
    else
    {
      ...
      this.dialog.open(SelectvisainvoicesComponent,{data:params,autoFocus:false,disableClose:true}).afterClosed().subscribe(data=>
        { this.finalTotal=0;
          // console.log(data)
  ...
  saveReceipt()
  {
    ...
    else
    {
      ...
      {       
        ...
        this.receiptService.addVisaReceipt(this.receipt).subscribe(data=>{
          ...
          this.selectedInvoices.forEach(element => {
            ...
            console.log(element)
            this.receiptService.addVisaInvoices(temp).subscribe();
          });
  ...
  getInvoicesData()
  {
    this.receiptService.getInvoiceInVisaReceipts(this.receipt).subscribe(data=>{
