...
@Component({
  ...
  templateUrl: './selectvisainvoices.component.html',
  styleUrls: ['./selectvisainvoices.component.scss']
})
export class SelectvisainvoicesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.invoiceService.getCustInvoicesInVisa(this.selectedCustomer).subscribe(data=>
      {
