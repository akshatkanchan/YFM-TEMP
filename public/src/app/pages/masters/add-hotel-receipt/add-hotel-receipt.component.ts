...
@Component({
  ...
  templateUrl: './add-hotel-receipt.component.html',
  styleUrls: ['./add-hotel-receipt.component.scss']
})
export class AddHotelReceiptComponent implements OnInit {
  ...
  addInvoices(){
    ...
    else
    {
      ...
      this.dialog.open(SelecthotelinvoicesComponent,{data:params,autoFocus:false,disableClose:true}).afterClosed().subscribe(data=>
        { this.finalTotal=0;
          // console.log(data)
  ...
  saveReceipt()
  {
    ...
    else
    {
      ...
      {       
        ...
        this.receiptService.addHotelReceipt(this.receipt).subscribe(data=>{
          ...
          this.selectedInvoices.forEach(element => {
            ...
            console.log(element)
            this.receiptService.addHotelInvoices(temp).subscribe(()=>{});
          });
  ...
  getInvoicesData()
  {
    this.receiptService.getInvoiceInHotelReceipts(this.receipt).subscribe(data=>{
