...
@Component({
  ...
  templateUrl: './selectflightinvoices.component.html',
  styleUrls: ['./selectflightinvoices.component.scss']
})
export class SelectflightinvoicesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.invoiceService.getCustInvoicesInFlights(this.selectedCustomer).subscribe(data=>
      {
