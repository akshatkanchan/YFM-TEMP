...
router.post('/retrieve', (req, res) => {
  ...
  connection.query(`select * from permissionsProfiles where ownerId='${req.body.ownerId}'`,function (err, result) {
    if (err) {
       connection.release();
    }
   res.json(result)
...
router.post('/add', (req, res) => {
  ...
  connection((err,connection)=>{
  connection.query("insert into permissionsProfiles set ?",req.body,function (err, result) {
    if (err) {
      console.log(err);
